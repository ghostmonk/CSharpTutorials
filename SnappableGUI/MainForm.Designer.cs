namespace SnappableGUI
{
   partial class MainForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.snapInModuleToolStripMenuItem.Click += new System.EventHandler( this.File_OnSelectedIndexChanged );
         // 
         // lstLoadedSnapIns
         // 
         this.lstLoadedSnapIns.FormattingEnabled = true;
         this.lstLoadedSnapIns.Location = new System.Drawing.Point( 13, 129 );
         this.lstLoadedSnapIns.Name = "lstLoadedSnapIns";
         this.lstLoadedSnapIns.Size = new System.Drawing.Size( 259, 69 );
         this.lstLoadedSnapIns.TabIndex = 1;
         this.lstLoadedSnapIns.SelectedIndexChanged += new System.EventHandler( this.File_OnSelectedIndexChanged );
         // 
         // MainForm
         // 
